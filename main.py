# Author: Fayas (https://github.com/FayasNoushad) (@NIKONEGOOGLESEARCHbot)
...
Made by @NIKONEGOOGLESEARCHbot"""

JOIN_BUTTON = [
    InlineKeyboardButton(
        text='⚙ Join Updates Channel ⚙',
        url='https://telegram.me/Developersrilankan'
    )
]
